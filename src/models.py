...
class NearEarthObject:
    ...
    def __init__(self, designation="", name=None, diameter=float('nan'), hazardous=False):
        ...
        :param designation: The primary designation for this NearEarthObject (defaults to "")
        :param name: The IAU name for this NearEarthObject (defaults to None)
        :param diameter: The diameter, in kilometers, of this NearEarthObject (defaults to float('nan'))
        :param hazardous: Whether or not this NearEarthObject is potentially hazardous (Defaults to False)
        """
    ...
    def fullname(self):
        ...
        return f"{self.designation} ({self.name if self.name else ''})".strip()
...
class CloseApproach:
    ...
    def __init__(self, time=None, distance=float('nan'), velocity=float('nan'), neo_designation=''):
